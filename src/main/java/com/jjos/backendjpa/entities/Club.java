...
public class Club {
    ...
    @OneToOne(targetEntity = Coach.class, cascade = CascadeType.PERSIST, fetch = FetchType.EAGER)
    @JoinColumn(name = "coach_id", referencedColumnName =  "id", foreignKey = @ForeignKey(name = "FK_CLUB_COACH"))
    private Coach coach;
